package co.edu.escuelaing.AREP.calcReflex;
...
public class CalcRealReflex {
        ...
        while(running){
            ...
            if (reqURL.getPath().startsWith("/compreFlex")){
                ...
                if (command.equals("bbl")){
                    ...
                    response = getCalculate(command, values );
                }
     ...
     */
    public static String getCalculate(String command, String[] values)  {
        Class<?> c = Math.class;
